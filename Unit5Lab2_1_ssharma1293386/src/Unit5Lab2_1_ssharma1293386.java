 ...
 */
public class Unit5Lab2_1_ssharma1293386 {
    ...
    public static void printMonthBody(int m, int y) {
        ...
        /*if (getStartDay(m, 1, y) == 7) {
            BlankSpaces = 0;
        }*/
        int TotalSpaces = MonthSpaces + BlankSpaces;

        for (int i = 1; i <= (int)(TotalSpaces / 7); i++) {
            //int MonthDay = i - BlankSpaces;
            System.out.print(" ");
            for (int j = 1; j <= 7; j++){
                int MonthDay = ((i*7) + j)  - BlankSpaces;
                if (MonthDay <= 0 )
                    System.out.printf("%4d", MonthDay);
                else 
                    System.out.print("    ");
